...
(function() {
  ...
  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link content@example.com][link&formatting&formatting-link >]");
  ...
  MT("linkEmail",
     "[link <content@example.com>] foo");

  MT("linkEmailDouble",
     "[link <content@example.com>] foo [link <content@example.com>]");
