...
var Popover = Class.extend({
	...
	// Triggered when the content clicks *anywhere* in the document, for the autoHide feature
...
var DragListener = fc.DragListener = Class.extend({
	...
	// Call this when the content does a mousedown. Will probably lead to startListening
	...
	// Called when the content moves the mouse
	...
	// Called when the content does a mouseup
	mouseup: function(ev) {
	...
	// Call this to stop listening to the content's mouse events
	...
	// Called when scrolling has stopped, whether through auto scroll, or the content scrolling
	scrollStop: function() {
	}
...
var MouseFollower = Class.extend({
	...
	// Gets called when the content moves the mouse
	mousemove: function(ev) {
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the content's mouse is over. null if over nothing
	...
	unrenderEvents: function() {
		this.triggerSegMouseout(); // trigger an eventMouseout if content's mouse is over an event
	...
	// Called when the content does a mousedown on an event, which might lead to dragging.
	...
	// Called when the content does a mousedown on an event's resizer, which might lead to resizing.
	// Generic enough to work with any type of Grid.
...
DayGrid.mixin({
	...
	showSegPopover: function(cell, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the content clicks elsewhere, hide the popover
...
var View = fc.View = Class.extend({
	...
	isRTL: false,
	isSelected: false, // boolean whether a range of time is content-selected or not
	...
	// Computes the new date when the content hits the prev button, given the current date
	...
	// Computes the new date when the content hits the next button, given the current date
	...
	// Computes the initial pre-configured scroll state prior to allowing the content to change it.
	...
	// Computes if the given event is allowed to be dragged by the content
	...
	// Computes if the given event is allowed to be resized by the content at all
	...
	// Handler for unselecting when the content clicks something and the 'unselectAuto' setting is on
	documentMousedown: function(ev) {
		var ignore;

		// is there a selection, and has the content made a proper left click?
...
function Calendar_constructor(element, overrides) {
	...
	function refetchEvents() { // can be called as an API method
		destroyEvents(); // so that events are cleared before content starts waiting for AJAX
