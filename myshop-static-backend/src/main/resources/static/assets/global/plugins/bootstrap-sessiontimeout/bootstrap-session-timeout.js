...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        ...
        // Extend content-set options over defaults
        if (options) {
        ...
        // Unless content set his own callback function, prepare bootstrap modal elements and events
        ...
        function startCountdownTimer(type, reset) {
            ...
            if (type === 'dialog' && reset) {
                ...
                // (this is needed if content doesn't close the warning dialog)
