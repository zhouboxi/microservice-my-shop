...
(function ($) {
    ...
    EditableForm.prototype = {
        ...
        **/        
        ...
        cancel: function() {   
            /**        
            Fired when form was cancelled by content
            @event cancel 
            @param {Object} event event object
            **/              
        ...
        save: function(submitValue) {
            ...
            */
            ...
            if (send) { //send to server
                ...
                if(typeof this.options.url === 'function') { //content's function
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        ...
        If it returns **object like** <code>{newValue: &lt;something&gt;}</code> - it overwrites value, submitted by content.
    ...
    **/  
    ...
    $.fn.editableContainer.defaults = {
        ...
        **/        
        autohide: true,
        /**
        Action when content clicks outside the container. Can be <code>cancel|submit|ignore</code>.
        ...
        initLive: function() {
           ...
           this.$element.on(this.options.toggle + '.editable', selector, $.proxy(function(e){
               ...
               if(!$target.data('editable')) {
                   //if delegated element initially empty, we need to clear it's text (that was manually set to `empty` by content)
    ...
    $.extend(Constructor.prototype, {
       ...
       value2input: function(value) {
           ...
           */
           ...
           this.$input.val(value).trigger('change', true); //second argument needed to separate initial change from content's click (for autosubmit)
           
           //if remote source AND no content's initSelection provided --> try to use element's text
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        ...
        /*
         ...
         content must pick some value from list, otherwise `null` returned.
