package com.zhouboxi.myshop.service.content.consumer.controller;
...
public class TbContentController {
    ...
    public DataTableDTO<TbContent> page(HttpServletRequest request, TbContent tbUser) {
        ...
        // 封装 Datatables 需要的结果
        PageInfo<TbContent> pageInfo = tbContentService.page(start, length, tbUser);
